...
class SshKeyAuth(Auth):
    def __init__(self, json_dict):
        verify_keys(json_dict, required=[NAME_KEY, TYPE_KEY,
                                         USERNAME_KEY, SSHKEY_KEY, PATH_KEY], optional=[PASSWORD_KEY])

        self.name = json_dict[NAME_KEY]
        self.username = json_dict[USERNAME_KEY]
        self.key = json_dict[SSHKEY_KEY]
        self.type = SSH_KEY_TYPE
        self.path = json_dict[PATH_KEY]
...
class Profile(object):
    def __init__(self, name, networks, auths, ports, win_enabled):
        """
    ...
    def to_dict(self):
        ...
        return {
            ...
            WIN_ENABLED_KEY: self.win_enabled
        }
    ...
    def enable_windows(self, win_enabled):
        self.win_enabled = win_enabled
...
class ConfigBuilder(object):
    ...
    def build_profiles(self, profiles_list):
        ...
        for profile_dict in profiles_list:
            ...
            profile_obj = Profile(name, ranges, auths, ports, win_enabled)
